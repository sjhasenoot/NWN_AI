...
void main()
{
    ...
    */
    ...
    if (sTag != "NPC_" + GetLocalString( OBJECT_SELF, "COLOR" ) + "_" +
        IntToString( GetLocalInt( OBJECT_SELF, "INDEX" ) ))
    {
        AssignCommand( GetObjectByTag( "BRAZIER" ), ActionSpeakString( sTag + " has incorrect parameters." ) );
    }
//    else
//    {
//        AssignCommand( GetObjectByTag( "BRAZIER" ), ActionSpeakString( sTag + " spawned." ) );
//    }

    ActivateUserDefined( EVENT_SPAWN );
}

...
void T2_HeartBeat()
{
    ...
    ActionSpeakString( "My target is "+sTarget, TALKVOLUME_SHOUT );
...
{
    SetTeamName( sColor, "Team2-" + GetStringLowerCase( sColor ) );
}
